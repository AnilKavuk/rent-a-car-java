...
public class TranmissionRepositoryHibernate implements TranmissionRepository {

    @Override
    public Tranmission add(Tranmission tranmission) {
        Random random=new Random();
        tranmission.setId(random.nextInt(1000));
        System.out.println("Tranmission added to db by TranmissionRepositoryHibernate");
        return tranmission;
    }
}
